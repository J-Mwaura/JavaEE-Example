...
import com.soekm.ejb.GroupsFacade;
...
public class GroupsController implements Serializable {
    ...
    @EJB
    private com.soekm.ejb.GroupsFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("bundles/Bundle").getString("GroupsCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("bundles/Bundle").getString("GroupsUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("bundles/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("bundles/Bundle").getString("GroupsDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("bundles/Bundle").getString("PersistenceErrorOccured"));
        }
    }
